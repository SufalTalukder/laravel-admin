@include('templates.after-login.header', ['title' => 'Admin Dashboard'])
                        ...
                        <div class="card-body pt-0">
                            <div class="table-responsive browser_users">
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img src="assets/images/logos/chrome.png" alt height="24"
                                        ...
                                        <!--end tr-->
                                        <tr>
                                            <td><img src="assets/images/logos/micro-edge.png" alt height="24"
                                        ...
                                        <!--end tr-->
                                        <tr>
                                            <td><img src="assets/images/logos/in-explorer.png" alt height="24"
                                        ...
                                        <!--end tr-->
                                        <tr>
                                            <td><img src="assets/images/logos/opera.png" alt height="24"
                                                    class="me-2">Opera</td>
...
@include('templates.after-login.footer')
